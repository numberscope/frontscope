...
## Otherwise, if you prefer a written guide...
...
8. [Submit a pull request](#submit-a-pull-request)
...
1. Sync your fork with the main numberscope/frontscope repository. The easiest
...
2. Navigate to the numberscope/frontscope repository. If your fork is synced
   up with the main numberscope/frontscope repository correctly, you should
   see a button that says ""
