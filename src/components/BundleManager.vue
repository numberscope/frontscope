<template>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div v-if="activeViz.isValid === undefined" class="alert alert-warning">Select a visualizer</div>
            <div v-else class="alert alert-primary">Active visualizer: {{activeViz.name}}</div>
        </div>
    </div>
