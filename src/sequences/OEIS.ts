...
/*
 * Note that this may not work as expected, as this won't be an actual sequence
 * once the sequence switcher is properly implemented. Rather, the sequences
 * generated by this OEIS class (the actual live sequences) will be stored in
