...
const featuredSIMs = [
    specimenQuery(
        ...
        'domain=0+1&turns=15+-165&steps=2+3'
            + '&pathLook=true&speed=10&bgColor=e0def7&strokeColor=5e8d85ff'
    ),
    specimenQuery(
        'Divisor Square',
        'Chaos',
    ...
    specimenQuery(
        ...
        'domain=0+1&turns=8+120&steps=40+400'
            ...
            + '&bgColor=4f4875&strokeColor=cec0c0ff',
    ...
    specimenQuery(
        ...
        '&domain=0+1+2&turns=79+0+45&steps=2.5+1.5+3'
            + '&pathLook=true&speed=10&bgColor=6c162b&strokeColor=be9b9ba0',
        '&modulus=3'
    ),
]
